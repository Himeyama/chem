...
const REACTION_CATEGORIES = [
  ...
  },
  {
    ...
    intro:
      "金属には溶けやすさの順番（イオン化傾向）があるよ。水素より溶けやすい亜鉛や鉄は塩酸・希硫酸に溶けて水素を出すけど、銅・銀・金の貴金属は溶けない。貴金属を溶かすには酸化力のある硝酸、金だけは王水が必要なんだ。",
    match: (r) =>
  ...
  },
  {
    title: "硫黄とその化合物",
    intro:
      "硫黄は S₂ どうしがくっついて S₄・S₆・S₈ と大きな環状分子に育つよ。燃やすと二酸化硫黄になり、これは酸性雨のもとにもなる気体なんだ。",
    match: (r) =>
      ["S4", "S6", "S8", "CS2", "SO2"].some((id) => r.products.includes(id)) &&
